...
const Customer = () => {
  ...
  const [tempSite, setTempSite] = useState<ISite>(initialSite);
    ...
    const addSite = useCallback((name: string, address: string, supervisorNumber:string, supervisorName:string) => {
        setFormData(prev => {
    ...
    //                         cursor: 'pointer',
    //                         border: 2,
    //                         borderColor: selectedSiteIndex === index ? '--var(primary-color)' : 'divider',
